...
import ArrowFooter from "@/components/buttons/ArrowFooter";
import FooterLinks, { LinkType } from "@/components/footer/FooterLinks";
import Social, { SocialLinkType } from "@/components/footer/Social";
